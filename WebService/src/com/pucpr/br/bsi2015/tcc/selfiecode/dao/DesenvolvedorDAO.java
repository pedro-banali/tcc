...
public class DesenvolvedorDAO {
	...
	public Usuario selectGer(Usuario usuario) {
	...
	public Desenvolvedor selectDevInativo(Usuario usuario) {
		...
		if (cf == null)
			...
			String selectSQL = "SELECT U.CPF, U.NOME, U.Nascimento, U.Login, UT.DATA_CADASTRO, UT.FK_TIPO_USUARIO, TU.DESCRICAO"
					+ " FROM USUARIO as U, USUARIO_TIPO as UT, TIPO_USUARIO as TU" + " WHERE U.CPF = UT.FK_CPF "
					+ " AND TU.ID_TIPO_USUARIO = UT.FK_TIPO_USUARIO " + " AND U.CPF = ? AND U.Ativo = 1";
	...
	public Usuario selectGervByLogin(Usuario usuario) {
	...
	public boolean cadastrarGer(Usuario u) {
		// TODO Auto-generated method stub
		...
		if (cf == null)
			...
			String selectSQL = "INSERT INTO USUARIO " + " (CPF, Nome, Nascimento, Senha, Login, Ativo) "
					+ " VALUES ( ?, ?, ?, ?, ?, 0)";
	...
	public boolean editarGer(Desenvolvedor u, long cpf) {
		// TODO Auto-generated method stub
