...
public class LayeredPackageTableView extends ViewPart implements
    ...
    private void supplementTitle(TreeItem item) {
        ...
        b.append(" - ").append(root.getText(1));
    ...
    public void displayDependencyGraph() {
        IGraphContributor source;
        String selectedPackage;
        if (table.getSelectionCount() > 0) {
            selectedPackage = table.getSelection()[0].getText(1);
        } else {
            selectedPackage = null;
        }
        source = (IGraphContributor) Dispatcher
                .getAbstractMetricSource(selection);
        displayDependencyGraphSWT(source.getEfferent(), selectedPackage);
    }
